...
void loop(){
  ...
  if(irValue > 10000){
    ...
    Particle.publish("testData", String(beatsPerMinute), PRIVATE);
  }
}
*/
...
#line 48 "/Users/hannahscomputer/Downloads/ECE413_final_project/heart_rate_sensor/src/heart_rate_sensor.ino"
